...
ENEM_ESCOLA_2019 <- ENEM_ESCOLA_2019 %>% filter(tipo != 'Privada')

# Pré-processamento
particaoENEM = createDataPartition(1:nrow(ENEM_ESCOLA_2019), p=.65) # cria a partição 70-30
